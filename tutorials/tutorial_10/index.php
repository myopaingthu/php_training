...
<body>
    <div class="container">
        <h1>Tutorial 10 Assignment</h1>
        <a href="create.php" class="btn btn-primary mb-2">Create new user</a>
        <a href="logout.php" class="btn btn-warning mb-2 float-right">Log Out</a>
        <?php
        session_start();
        ...
        $query = "SELECT id, name, password, age, description, created_at FROM tutorial10.users ORDER BY id DESC";
